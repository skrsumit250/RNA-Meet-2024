...
function Speaker(){
    return(
        ...
        <section className="col">
            <div className="row">
                <div className="speaker">
                    <img src="/Speakers/Amaresh C Panda.jpg" alt="speaker"></img>
                    <li><a target="_blank" href="https://www.ils.res.in/scientists/amaresh-c-panda/">Amaresh C Panda</a></li>
                    <h3>ILS</h3>
                </div>
                <div className="speaker">
                    <img src="/Speakers/Amanjot Singh.jpg" alt="speaker"></img>
                ...
                <div className="speaker">
                    <img src="/Speakers/Arumugam Rajavelu.jpg" alt="speaker"></img>
            ...
            <div className="row">  
                <div className="speaker">
                    <img src="/Speakers/Bhupendra Verma.jpg" alt="speaker"></img>
                ...
                <div className="speaker">
                    <img src="/Speakers/Dasaradhi Palakodeti.png" alt="speaker"></img>
                    <li><a target="_blank" href="https://www.instem.res.in/faculty/dasaradhi">Dasaradhi Palakodeti</a></li>
                    <h3>inSTEM</h3>
                </div> 
                <div className="speaker">
                    <img src="/Speakers/Dimple Notani.jpg" alt="speaker"></img>
        ...
        <section className="col">
            <div className="row">
                <div className="speaker">
                    <img src="/Speakers/Jomon Joseph.jpg" alt="speaker"></img>
        ...
        <section className="col">
            ...
            <div className="row">
                <div className="speaker">
                    <img src="/Speakers/Zhumur Ghosh.jpeg" alt="speaker"></img>
